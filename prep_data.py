"""A script to import and prepare data."""
import pandas as pd
import numpy as np
import re
...
data_path = (
 '~/Downloads/HISTDATA_COM_ASCII_EURUSD_M12016/DAT_ASCII_EURUSD_M1_2016.csv')
...
def convert_dt(dt):
    """Convert date/time format to number of minutes."""
    dt_li = dt.split()
...
def segment(times, x):
    """Split data into sessions according to breaks."""
